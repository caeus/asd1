...
class Bind:
    ...
    def __init__(self, binder: injector.Binder):
        self.binder = binder
    def value(self,type:typing.Type[T],value:T)->None:
        self.binder.bind(
            type,
            injector.InstanceProvider(value),
            injector.SingletonScope
        )
    def singleton(self, callable: typing.Callable[..., T]) -> None:
        if inspect.isclass(callable):
            ...
            if "return" in annotations:
                ...
                raise Exception(f"callable {callable} doesn't have return type")
    @classmethod
